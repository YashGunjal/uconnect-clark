...
const AvatarInitials = memo(function AvatarInitials({ firstName, lastName }) {
  const whitebackcolors = [
    "#E2DFD2", "#FFF5EE", "#F3E5AB", "#FFFAFA", "#F0FFF0", "#F5FFFA", "#F0FFFF", "#F0F8FF", "#FF5733",
    "#F3EB3F", "#3FF38B", "#3FF3CF", "#41C3EC", "#8D41EC", "#D941EC", "#EC4194", "#F63F4A",
  ];
  ...
  return (
    <div
      className={ style.avatarCustom + " avatar" }
      style={{
